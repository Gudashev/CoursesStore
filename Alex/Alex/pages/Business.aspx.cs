...
namespace Alex.pages
{
    ...
    public partial class Business : System.Web.UI.Page
    {
        ...
        {  // Метод берет товары из БД и выводит их на страницу
            ...
            {
                if (item[1] != "bus") continue;  // Если это курс не по иностранному, то переходим к сл товару
                if (count % 3 == 0 && count != 0)  // Если это каждый 3 выведенный на страницу товар
                    Response.Write("</div><div class='row'>");
                Response.Write(String.Format(@"
                    <div class='col-4 item'>
                        <a>
                            <img class='image' src='../content/business/images/{1}'>
                        </a><br>
                        <span class='title'>{2}</span><br>
                        <span class='description'>{3}</span>
                        <br><br>
                        <a id='{0}' class='buy shadow' href=''>Купить за {4}Р.</a>
                    </div>
